  ...
  return (
    <section id="appGallery" style={{ background: "#cecece" }}>
      <div className=" grid grid-rows-4">
        ...
        >
          <h1>Level up your haircut experience.</h1>
        ...
        <div>
          <button
            className="text-gray-300 text-3xl font-thin mt-16 px-8 pt-3 px-5 pb-4 rounded-full"
      ...
      <div className="grid grid-cols-8 gap-5 px-20 gallery-animate pb-0 mb-0">
        <div
        ...
        <div className="flex flex-col col-span-2 neomorph-phone h-min p-3 pb-6">
          <img
            src={splash}
